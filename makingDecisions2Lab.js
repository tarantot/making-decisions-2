...
var lastItemRemoved = arr.splice(arr.length - 1);
console.log(arr)
...
let compare = 7;
if (myFavoriteNumbers.length < compare) {
  console.log('There are not enough elements in this array');
} else {
  var someNum = myFavoriteNumbers[compare - 1];
}
...
for (var number = 0; number < listOfNumbers.length; number++) {
...
for (var letter = letters.length - 1; letter >= 0; letter--) {
